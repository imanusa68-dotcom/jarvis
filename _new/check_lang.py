...
VOICE_REFERENCE = {
    ...
    "main.py": ("e0f6627e760a8283e5daad26a9cc0812", 145845),
...
if _stale:
    ...
    print("   эталон голоса переснят: main.py 29.08.2026 (шаг 6, "
          "выключатели диагностики и пробел из cmd), ui.py 22.08.2026")
print()
