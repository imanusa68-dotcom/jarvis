...
VOICE_REFERENCE = {
    ...
    "main.py": ("6216e17758e8394b06897256574c4db1", 157330),
...
if _stale:
    ...
    print("   эталон голоса переснят: main.py 29.08.2026 (шаг 2'', "
          "нечего записывать и новый человек в описании "
          "save_memory), ui.py 22.08.2026")
print()
